...
const corsOptions = {
  origin: ['https://ai-factory.apoorvnema.com', 'http://localhost:3000', 'https://localhost', 'chrome-extension:// aladahbkiglabbcambbjcgocabgkpcop'], // Specify the allowed origin(s)
